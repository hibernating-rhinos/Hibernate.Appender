...
public class ProfilerConfiguration {
    ...
    public void configure(Properties properties) {
        ...
        properties.put(Environment.BATCH_STRATEGY, ProfilerBatchingBatcherFactory.class.getName());
    ...
    public String configure(String string) {
        ...
        buffer.append(Environment.BATCH_STRATEGY).append("=").append(ProfilerBatchingBatcherFactory.class.getName()).append("\n");
